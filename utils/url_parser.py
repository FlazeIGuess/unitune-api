...
class URLParser:
    ...
    PATTERNS = {
        ...
        'tidal': [
            (r'tidal\.com/track/(\d+)(?:/.*)?', ContentType.TRACK),
            (r'tidal\.com/browse/track/(\d+)', ContentType.TRACK),
            (r'listen\.tidal\.com/track/(\d+)(?:/.*)?', ContentType.TRACK),
            (r'tidal\.com/album/(\d+)(?:/.*)?', ContentType.ALBUM),
            (r'tidal\.com/browse/album/(\d+)', ContentType.ALBUM),
            (r'listen\.tidal\.com/album/(\d+)(?:/.*)?', ContentType.ALBUM),
            (r'tidal\.com/artist/(\d+)(?:/.*)?', ContentType.ARTIST),
            (r'tidal\.com/browse/artist/(\d+)', ContentType.ARTIST),
            (r'listen\.tidal\.com/artist/(\d+)(?:/.*)?', ContentType.ARTIST),
        ],
        'amazonMusic': [
